...
int main()
{
    ...
    else if (line[0] == '2')
    {
        Game g(10, 10);
        addStandardShips(g);
        Player* p1 = createPlayer("human", "Human", g);
        Player* p2 = createPlayer("mediocre", "Good Jesus", g);
        g.play(p1, p2);
        delete p1;
        delete p2;
    }
    else if (line[0] == '3')
    {
        ...
        for (int k = 1; k <= NTRIALS; k++)
        {
            ...
            Game g(10, 10);
            addStandardShips(g);
            Player* p1 = createPlayer("good", "God", g);
            Player* p2 = createPlayer("mediocre", "Midori", g);
            Player* winner = (k % 2 == 1 ?
        ...
        cout << "The good player won " << NTRIALS - nMediocreWins << " out of "
             << NTRIALS << " games." << endl;
